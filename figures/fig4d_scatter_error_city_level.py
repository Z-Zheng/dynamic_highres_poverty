...
gt, pr = np.load('./data/gt_pr_bl_Transformer/0_gt_pr.npy')
r2 = r2_score(gt, pr)
print(f'R2: {r2:.2f}')
...
g = sns.JointGrid()
sns.scatterplot(x=gt, y=pr, s=5, legend=False, alpha=0.6, edgecolor=None, color='black', ax=g.ax_joint)
g.ax_joint.set_title('City | Blantyre (2023)')
...
g.ax_joint.set_xlabel('Survey-measured asset wealth')
g.ax_joint.set_ylabel('Model-predicted asset wealth')
